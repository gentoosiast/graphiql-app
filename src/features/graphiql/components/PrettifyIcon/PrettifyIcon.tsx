...
export const PrettifyIcon = createSvgIcon(
  <svg
    aria-hidden="true"
  ...
  >
    ...
    <path d="M10.2852 24.0745L13.7139 18.0742" stroke="currentColor" strokeWidth="1.5625"></path>
    <path d="M14.5742 24.0749L17.1457 19.7891" stroke="currentColor" strokeWidth="1.5625"></path>
    <path
